...
-- AddForeignKey
ALTER TABLE `rps_game_record` ADD CONSTRAINT `rps_game_record_ibfk_1` FOREIGN KEY (`user_no`) REFERENCES `user`(`no`) ON DELETE CASCADE ON UPDATE CASCADE;
